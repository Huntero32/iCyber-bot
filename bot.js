...
bot.on('message', message => {
    ...
    if (msg === prefix + 'PING') { // This checks if msg (the message but in all caps), is the same as the prefix + the command in all caps.
        ...
        message.channel.send('WHO PINGED ME!!    Was it Hunter?... just wait until I find him...'); // This 'sends' the message to the channel the message was in. You can change what is in the message to whatever you want.
    ...
    if (msg.startsWith(prefix + 'PURGE')) { // This time we have to use startsWith, since we will be adding a number to the end of the command.
        ...
        async function purge() {
            ...
            if (!message.member.roles.find("name", "Hunter")) { // This checks to see if they DONT have it, the "!" inverts the true/false
                message.channel.send('You need the \`Hunter\` role to use this command.'); // This tells the user in chat that they need the role.
...
if(msg === prefix + 'kick') {
    ...
    if(!message.member.roles.some(r=>["Hunter"].includes(r.name)) )
...
bot.on('ready', () => {
	//Posts into console saying that the bot was launched.
	console.log('iCyber Bot Loading........Starting up........iCyber Bot sucessfully started. \n Welcome Hunter');
});
